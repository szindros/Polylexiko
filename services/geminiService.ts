...
4. ΕΠΙΘΕΤΑ: Εάν η λέξη είναι επίθετο, ο πίνακας γραμματικής (grammarTable) ΠΡΕΠΕΙ να περιλαμβάνει την κλίση και στα ΤΡΙΑ ΓΕΝΗ ταυτόχρονα.
...
6. ΕΤΥΜΟΛΟΓΙΑ: Παρέχετε μια συνοπτική αλλά περιεκτική ετυμολογική ανάλυση σε μία παράγραφο κειμένου.
